const materialOptions = [
  // Flexible Plastic
  { value: "Flexible Plastic - LDPE", label: "Flexible Plastic - LDPE" },
  { value: "Flexible Plastic - Polyethylene", label: "Flexible Plastic - Polyethylene" },
  { value: "Flexible Plastic - Starch Polymer", label: "Flexible Plastic - Starch Polymer" },
  { value: "Flexible Plastic - Composite Polymer", label: "Flexible Plastic - Composite Polymer" },
  { value: "Flexible Plastic - Other", label: "Flexible Plastic - Other" },

  // Rigid Plastic
  { value: "Rigid Plastic - LDPE", label: "Rigid Plastic - LDPE" },
  { value: "Rigid Plastic - Colored HDPE", label: "Rigid Plastic - Colored HDPE" },
  { value: "Rigid Plastic - Natural HDPE", label: "Rigid Plastic - Natural HDPE" },
  { value: "Rigid Plastic - PVC", label: "Rigid Plastic - PVC" },
  { value: "Rigid Plastic - PET", label: "Rigid Plastic - PET" },
  ...
  // Non-Ferrous Metal
  { value: "Non-Ferrous Metal - Aluminum", label: "Non-Ferrous Metal - Aluminum" },
  { value: "Non-Ferrous Metal - Copper", label: "Non-Ferrous Metal - Copper" },
  ...
  { value: "E-Waste - Circuit Board", label: "E-Waste - Circuit Board" },
  { value: "E-Waste - Battery", label: "E-Waste - Battery" },
  { value: "E-Waste - CDROM", label: "E-Waste - CDROM" },
  { value: "E-Waste - Phone", label: "E-Waste - Phone" },
  { value: "E-Waste - Lightbulb", label: "E-Waste - Lightbulb" },
  { value: "E-Waste - Other", label: "E-Waste - Other" },
  ...
  // Rigid Fiber
  { value: "Rigid Fiber - Molded Pulp", label: "Rigid Fiber - Molded Pulp" },
  { value: "Rigid Fiber - Cardboard (OCC)", label: "Rigid Fiber - Cardboard (OCC)" },
  ...
  { value: "Bio - Plant", label: "Bio - Plant" },
